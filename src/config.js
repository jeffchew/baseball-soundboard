...
export const audioConfig = {
  ...
  songs: [
    ...
    { id: 'song3', label: 'Are You Gonna Go My Way', file: audioUrl('/audio/songs/Are You Gonna Go My Way.mp3'), startTime: 0, fadeIn: false },
    ...
    { id: 'song7', label: 'Blitzkrieg Bop', file: audioUrl('/audio/songs/Blitzkrieg Bop.mp3'), startTime: 0, fadeIn: false },
    //{ id: 'song7a', label: 'California Love', file: audioUrl('/audio/songs/California Love.mp3'), startTime: 0, fadeIn: false },
    { id: 'song7b', label: "Can't Hold Us", file: audioUrl('/audio/songs/Can_t Hold Us.mp3'), startTime: 0, fadeIn: false },
    { id: 'song8', label: "Can't Stop The Feeling!", file: audioUrl('/audio/songs/Can_t Stop The Feeling!.mp3'), startTime: 41, fadeIn: true },
    { id: 'song9', label: 'Centerfield', file: audioUrl('/audio/songs/Centerfield.mp3'), startTime: 0, fadeIn: false },
    { id: 'song10', label: 'Crazy Little Thing Called Love', file: audioUrl('/audio/songs/Crazy Little Thing Called Love.mp3'), startTime: 0, fadeIn: false },
    { id: 'song11', label: 'Crazy Train', file: audioUrl('/audio/songs/Crazy Train.mp3'), startTime: 0, fadeIn: false },
    ...
    { id: 'song14b', label: 'Espresso', file: audioUrl('/audio/songs/Espresso.mp3'), startTime: 0, fadeIn: false },
    { id: 'song15', label: 'Eye of the Tiger', file: audioUrl('/audio/songs/Eye of the Tiger.mp3'), startTime: 0, fadeIn: false },
    //{ id: 'song16', label: 'Trap Queen', file: audioUrl('/audio/songs/Fetty Wap - Trap Queen (Clean).mp3'), startTime: 0, fadeIn: true },
    { id: 'song16a', label: "Gettin' Jiggy Wit It", file: audioUrl("/audio/songs/Gettin' Jiggy Wit It.mp3"), startTime: 0, fadeIn: false },
    { id: 'song16b', label: 'Happy', file: audioUrl('/audio/songs/Happy.mp3'), startTime: 0, fadeIn: false },
    { id: 'song17', label: 'Hells Bells', file: audioUrl('/audio/songs/Hells Bells.mp3'), startTime: 19, fadeIn: true },
    { id: 'song18', label: 'Highway to Hell', file: audioUrl('/audio/songs/Highway to Hell.mp3'), startTime: 0, fadeIn: false },
    { id: 'song18b', label: 'Hypnotize', file: audioUrl('/audio/songs/Hypnotize.mp3'), startTime: 0, fadeIn: false },
    { id: 'song19', label: 'I Believe That We Will Win', file: audioUrl('/audio/songs/I Believe That We Will Win (World Anthem).mp3'), startTime: 0, fadeIn: false },
    ...
    { id: 'song21', label: 'Jump Around', file: audioUrl('/audio/songs/Jump Around.mp3'), startTime: 0, fadeIn: false },
    { id: 'song22', label: 'Kickstart My Heart', file: audioUrl('/audio/songs/Kickstart My Heart.mp3'), startTime: 0, fadeIn: false },
    ...
    { id: 'song24b', label: 'Mr. Brightside', file: audioUrl('/audio/songs/Mr Brightside.mp3'), startTime: 0, fadeIn: false },
    ...
    { id: 'song26', label: "No Sleep 'Til Brooklyn", file: audioUrl('/audio/songs/No Sleep _Til Brooklyn.mp3'), startTime: 0, fadeIn: false },
    { id: 'song27', label: 'Paradise City', file: audioUrl('/audio/songs/Paradise City.mp3'), startTime: 0, fadeIn: false },
    { id: 'song28', label: 'Never Gonna Give You Up', file: audioUrl('/audio/songs/Rick Astley - Never Gonna Give You Up.mp3'), startTime: 0, fadeIn: false },
    { id: 'song28b', label: 'Renegade', file: audioUrl('/audio/songs/Renegade.mp3'), startTime: 42, fadeIn: true },
    { id: 'song29', label: 'Sabotage', file: audioUrl('/audio/songs/Sabotage.mp3'), startTime: 0, fadeIn: false },
    { id: 'song29b', label: 'September', file: audioUrl('/audio/songs/September.mp3'), startTime: 0, fadeIn: false },
    { id: 'song30', label: 'Seven Nation Army', file: audioUrl('/audio/songs/Seven Nation Army.mp3'), startTime: 0, fadeIn: false },
    { id: 'song31', label: 'Shook Ones, Pt. II', file: audioUrl('/audio/songs/Shook Ones, Pt. II.mp3'), startTime: 23, fadeIn: true },
    { id: 'song31b', label: 'Shake It Off', file: audioUrl('/audio/songs/Shake It Off.mp3'), startTime: 0, fadeIn: false },
    { id: 'song32', label: 'Shoot To Thrill', file: audioUrl('/audio/songs/Shoot To Thrill.mp3'), startTime: 0, fadeIn: false },
    ...
    { id: 'song33a', label: 'Start Me Up', file: audioUrl('/audio/songs/Start Me Up.mp3'), startTime: 0, fadeIn: false },
    { id: 'song33b', label: 'Summer Love', file: audioUrl('/audio/songs/Summer Love.mp3'), startTime: 0, fadeIn: false },
    { id: 'song33b2', label: 'Summertime', file: audioUrl('/audio/songs/Summertime.mp3'), startTime: 0, fadeIn: false },
    { id: 'song33c', label: 'Swag Surfin', file: audioUrl('/audio/songs/Swag Surfin.mp3'), startTime: 0, fadeIn: false },
    { id: 'song33d', label: 'Stayin Alive', file: audioUrl('/audio/songs/Stayin Alive.mp3'), startTime: 0, fadeIn: false },
    { id: 'song34', label: 'Sweet Caroline', file: audioUrl('/audio/songs/Sweet Caroline.mp3'), startTime: 0, fadeIn: false },
    { id: 'song35', label: "Sweet Child O' Mine", file: audioUrl('/audio/songs/Sweet Child O_ Mine.mp3'), startTime: 0, fadeIn: false },
    ...
    { id: 'song36a', label: 'Take on Me', file: audioUrl('/audio/songs/Take on Me.mp3'), startTime: 0, fadeIn: false },
    { id: 'song36b', label: 'The Final Countdown', file: audioUrl('/audio/songs/The Final Countdown.mp3'), startTime: 12, fadeIn: true },
    { id: 'song37', label: 'The Imperial March', file: audioUrl('/audio/songs/The Imperial March.mp3'), startTime: 0, fadeIn: false },
    { id: 'song38', label: 'Theme From New York, New York', file: audioUrl('/audio/songs/Theme From New York, New York.mp3'), startTime: 0, fadeIn: false },
    { id: 'song38b', label: 'Thunder', file: audioUrl('/audio/songs/Thunder.mp3'), startTime: 0, fadeIn: false },
    { id: 'song39', label: 'Thunderstruck', file: audioUrl('/audio/songs/Thunderstruck.mp3'), startTime: 0, fadeIn: false },
    { id: 'song40', label: 'Uptown Funk', file: audioUrl('/audio/songs/Uptown Funk.mp3'), startTime: 13, fadeIn: true },
    { id: 'song42', label: 'We Ready', file: audioUrl('/audio/songs/We Ready.mp3'), startTime: 0, fadeIn: false },
    { id: 'song43', label: 'We Will Rock You', file: audioUrl('/audio/songs/We Will Rock You.mp3'), startTime: 0, fadeIn: false },
    { id: 'song44', label: 'Welcome To The Jungle', file: audioUrl('/audio/songs/Welcome To The Jungle.mp3'), startTime: 0, fadeIn: false },
    { id: 'song44b', label: 'Whole Lotta Love', file: audioUrl('/audio/songs/Whole Lotta Love.mp3'), startTime: 0, fadeIn: false },
    { id: 'song45', label: 'YMCA', file: audioUrl('/audio/songs/YMCA.mp3'), startTime: 0, fadeIn: false },
