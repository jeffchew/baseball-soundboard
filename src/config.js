...
export const audioConfig = {
  ...
  sounds: [
    ...
    { id: 'addams-family', label: 'Addams Family', file: audioUrl('/audio/sounds/addams_family_theme.mp3'), startTime: 0, fadeIn: false, category: 'at-bat', initialDelay: 0.75 },
    { id: 'imperial', label: 'Two Strikes', file: audioUrl('/audio/sounds/imperial_siren.mp3'), startTime: 0, fadeIn: false, category: 'at-bat', initialDelay: 0.75 },
    { id: 'mario-coin-atbat', label: 'Mario Coin', file: audioUrl('/audio/sounds/mario_coin.mp3'), startTime: 0, fadeIn: false, category: 'at-bat', initialDelay: 0.75 },
    { id: 'slide-whistle', label: 'Slide Whistle 1', file: audioUrl('/audio/sounds/slide_whistle.mp3'), startTime: 0, fadeIn: false, category: 'at-bat', initialDelay: 0.75 },
    { id: 'slide-whistle2', label: 'Slide Whistle 2', file: audioUrl('/audio/sounds/slide_whistle2.mp3'), startTime: 0, fadeIn: false, category: 'at-bat', initialDelay: 0.75 },
    { id: 'sonic-ring-atbat', label: 'Sonic Ring', file: audioUrl('/audio/sounds/sonic_ring.mp3'), startTime: 0, fadeIn: false, category: 'at-bat', initialDelay: 0.75 },
    { id: 'strikeout-mario', label: 'Strikeout: Mario', file: audioUrl('/audio/sounds/super_mario_death.mp3'), startTime: 0, fadeIn: false, category: 'at-bat', initialDelay: 0.75 },
    ...
    { id: 'strikeout-pacman', label: 'Strikeout: Pac-Man', file: audioUrl('/audio/sounds/pac_man_death.mp3'), startTime: 0, fadeIn: false, category: 'at-bat', initialDelay: 0.75 },
    { id: 'strikeout-pc-richards', label: 'Strikeout: PC Richards', file: audioUrl('/audio/sounds/pc_richard_and_son_whi.mp3'), startTime: 0, fadeIn: false, category: 'at-bat', initialDelay: 0.75 },
    ...
    { id: 'lava-chicken', label: "Steve's Lava Chicken", file: audioUrl('/audio/songs/Jack Black - Steve_s Lava Chicken.mp3'), startTime: 8, fadeIn: true, category: 'hype' },
    ...
    { id: 'cash-register', label: 'Cash Register', file: audioUrl('/audio/sounds/cash_register.mp3'), startTime: 0, fadeIn: false, category: 'steal', initialDelay: 0.75 },
    { id: 'metal-gear-alert', label: 'Metal Gear Alert', file: audioUrl('/audio/sounds/metal_gear_alert.mp3'), startTime: 0, fadeIn: false, category: 'steal', initialDelay: 0.75 },
    ...
    { id: 'cowabunga', label: 'Cowabunga', file: audioUrl('/audio/sounds/tmnt_cowabunga.mp3'), startTime: 0, fadeIn: false, category: 'hit-short', initialDelay: 0.75 },
    { id: 'dj-air-horn', label: 'DJ Air Horn', file: audioUrl('/audio/sounds/dj_air_horn.mp3'), startTime: 0, fadeIn: false, category: 'hit-short', initialDelay: 0.75 },
    ...
    { id: 'sonic-rings', label: 'Sonic Rings', file: audioUrl('/audio/sounds/sonic_rings_3x.mp3'), startTime: 0, fadeIn: false, category: 'hit-short', initialDelay: 0.75 },
  ...
  songs: [
    ...
    { id: 'song4', label: "Baba O'Riley", file: audioUrl('/audio/songs/Baba O_Riley.mp3'), startTime: 32, fadeIn: true, category: 'rock' },
    ...
    { id: 'song7b', label: "Can't Hold Us", file: audioUrl('/audio/songs/Can_t Hold Us.mp3'), startTime: 0, fadeIn: false, category: 'hip-hop' },
    { id: 'song8', label: "Can't Stop The Feeling!", file: audioUrl('/audio/songs/Can_t Stop The Feeling!.mp3'), startTime: 41, fadeIn: true, category: 'upbeat' },
    ...
    { id: 'song12', label: "Don't Stop 'til You Get Enough", file: audioUrl('/audio/songs/Don_t Stop _til You Get Enough.mp3'), startTime: 14, fadeIn: true, category: 'upbeat' },
    ...
    { id: 'song26', label: "No Sleep 'Til Brooklyn", file: audioUrl('/audio/songs/No Sleep _Til Brooklyn.mp3'), startTime: 0, fadeIn: false, category: 'rock' },
    ...
    { id: 'song35', label: "Sweet Child O' Mine", file: audioUrl('/audio/songs/Sweet Child O_ Mine.mp3'), startTime: 0, fadeIn: false, category: 'rock' },
