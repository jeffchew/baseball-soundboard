...
export const audioConfig = {
  ...
  sounds: [
    { id: 'baby-shark', label: 'Baby Shark', file: audioUrl('/audio/sounds/Baby Shark.mp3'), startTime: 0, fadeIn: false },
    { id: 'calvary', label: 'Calvary Charge', file: audioUrl('/audio/sounds/Calvary Charge.mp3'), startTime: 0, fadeIn: false },
    { id: 'charge', label: 'Charge!', file: audioUrl('/audio/sounds/Charge Organ.mp3'), startTime: 0, fadeIn: false },
    { id: 'riser', label: 'Cinematic Riser', file: audioUrl('/audio/sounds/Cinematic-riser-boom.mp3'), startTime: 0, fadeIn: false },
    { id: 'drums1', label: 'Drums 1', file: audioUrl('/audio/sounds/drums 1.mp3'), startTime: 0, fadeIn: false },
    { id: 'drums2', label: 'Drums 2', file: audioUrl('/audio/sounds/drums 2.mp3'), startTime: 0, fadeIn: false },
    { id: 'drums3', label: 'Drums 3', file: audioUrl('/audio/sounds/drums 3.mp3'), startTime: 0, fadeIn: false },
    { id: 'drums4', label: 'Drums 4', file: audioUrl('/audio/sounds/drums 4.mp3'), startTime: 0, fadeIn: false },
    { id: 'drums5', label: 'Drums 5', file: audioUrl('/audio/sounds/drums 5.mp3'), startTime: 0, fadeIn: false },
    { id: 'drums6', label: 'Drums 6', file: audioUrl('/audio/sounds/drums 6.mp3'), startTime: 0, fadeIn: false },
    { id: 'imperial', label: 'Two Strikes', file: audioUrl('/audio/sounds/imperial_siren.mp3'), startTime: 0, fadeIn: false },
    { id: 'lets-go', label: "Let's Go", file: audioUrl('/audio/sounds/organ let_s go.mp3'), startTime: 0, fadeIn: false },
    { id: 'greek-chant', label: 'Greek Chant', file: audioUrl('/audio/sounds/organ-greek-chant (1).mp3'), startTime: 0, fadeIn: false },
    { id: 'whistle', label: 'Strikeout', file: audioUrl('/audio/sounds/pc_richard_and_son_whi.mp3'), startTime: 0, fadeIn: false },
    { id: 'james-bond', label: 'Walk (007)', file: audioUrl('/audio/sounds/007 James Bond Theme.mp3'), startTime: 36, fadeIn: true },
    { id: 'walkin', label: "Walk (I'm Walkin')", file: audioUrl('/audio/sounds/Fats Domino - I_m Walkin_.mp3'), startTime: 0, fadeIn: false },
    { id: 'jaws', label: 'Walk (Jaws Theme)', file: audioUrl('/audio/sounds/Jaws - Theme.mp3'), startTime: 55, fadeIn: true },
    { id: 'song33', label: 'Walk (Smooth Criminal)', file: audioUrl('/audio/songs/Smooth Criminal.mp3'), startTime: 13, fadeIn: true },
    { id: 'take-walk', label: 'Walk (Take a Walk)', file: audioUrl('/audio/sounds/Take a Walk.mp3'), startTime: 90, fadeIn: true },
    { id: 'boots-walking', label: 'Walk (These Boots)', file: audioUrl('/audio/sounds/These Boots Are Made For Walking.mp3'), startTime: 0, fadeIn: false },
    { id: 'walk-man', label: 'Walk (Walk Like a Man)', file: audioUrl('/audio/sounds/Walk Like a Man.mp3'), startTime: 43, fadeIn: true },
    { id: 'song41', label: 'Walk (Walk This Way)', file: audioUrl('/audio/songs/Walk This Way.mp3'), startTime: 60, fadeIn: true },
    { id: 'all-star', label: 'Run/Hit: All Star', file: audioUrl('/audio/sounds/All Star.mp3'), startTime: 52, fadeIn: true },
    { id: 'cant-touch', label: "Run/Hit: U Can't Touch This", file: audioUrl("/audio/sounds/U Can_t Touch This.mp3"), startTime: 0, fadeIn: false },
    { id: 'celebration', label: 'Run/Hit: Celebration', file: audioUrl('/audio/sounds/Celebration.mp3'), startTime: 32, fadeIn: true },
    { id: 'dogs-out', label: 'Run/Hit: Who Let the Dogs Out', file: audioUrl('/audio/sounds/Who Let The Dogs Out.mp3'), startTime: 0, fadeIn: false },
    { id: 'ff-victory', label: 'Run/Hit: Final Fantasy Victory', file: audioUrl('/audio/sounds/final-fantasy-vii-victory-fanfare.mp3'), startTime: 0, fadeIn: false },
    { id: 'i-feel-good', label: 'Run/Hit: I Got You (I Feel Good)', file: audioUrl('/audio/sounds/I Got You (I Feel Good).mp3'), startTime: 0, fadeIn: false },
    { id: 'level-up', label: 'Run/Hit: Level Up', file: audioUrl('/audio/sounds/Level Up.mp3'), startTime: 6, fadeIn: true },
    { id: 'mario-star', label: 'Run/Hit: Mario Star Theme', file: audioUrl('/audio/sounds/mario_star_theme.mp3'), startTime: 0, fadeIn: false },
    { id: 'mario-victory', label: 'Run/Hit: Super Mario Victory', file: audioUrl('/audio/sounds/super_mario_victory.mp3'), startTime: 0, fadeIn: false },
    { id: 'whoomp', label: 'Run/Hit: Whoomp! (There It Is)', file: audioUrl('/audio/sounds/Whoomp! (There It Is).mp3'), startTime: 30, fadeIn: true },
  ],
